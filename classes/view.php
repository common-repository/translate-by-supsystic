<?php
abstract class viewTbs extends baseObjectTbs {
    /* 
     * @deprecated
     */
    protected $_tpl = TBS_DEFAULT;
    /*
	...
	public function getPath($tpl) {
		$path = '';
		$parentModule = frameTbs::_()->getModule( $this->_code );
	...
	public function getModel($code = '') {
		return frameTbs::_()->getModule( $this->_code )->getController()->getModel($code);
	}
