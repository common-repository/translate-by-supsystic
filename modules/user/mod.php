<?php
class userTbs extends moduleTbs {
    ...
    public function isAdmin() {
        ...
        return current_user_can( frameTbs::_()->getModule('adminmenu')->getMainCap() );
    }
	...
	protected function _loadUserData() {
		if(!$this->_dataLoaded) {
			if(!function_exists('wp_get_current_user')) frameTbs::_()->loadPlugins();
	...
	public function getAdminsList() {
		global $wpdb;
		$admins = dbTbs::get('SELECT * FROM #__users 
