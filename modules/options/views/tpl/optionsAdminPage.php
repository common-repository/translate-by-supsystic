<div class="wrap">
    <div class="supsystic-plugin">
        <?php /*?><header class="supsystic-plugin">
            <h1><?php echo TBS_WP_PLUGIN_NAME?></h1>
        </header><?php */?>
		<?php echo $this->breadcrumbs?>
        <section class="supsystic-content">
            <nav class="supsystic-navigation supsystic-sticky <?php dispatcherTbs::doAction('adminMainNavClassAdd')?>">
                <ul>
...
<div id="tbsOptInProWnd" style="display: none;" title="<?php _e('Improve Free version', TBS_LANG_CODE)?>">
	<p id="tbsOptWndTemplateTxt" style="display: none;">
		<?php printf(__('Please be advised that this template with all other options and PRO templates is available only in <a target="_blank" href="%s">PRO version</a>. You can <a target="_blank" href="%s" class="button">Get PRO</a> today and get this and other PRO templates and features for your PopUps!', TBS_LANG_CODE), $this->mainLink, $this->mainLink)?>
	</p>
	<p id="tbsOptWndOptionTxt">
		<?php printf(__('Please be advised that this option is available only in <a target="_blank" href="%s">PRO version</a>. You can <a target="_blank" href="%s" class="button">Get PRO</a> today and get this and other PRO option for your PopUps!', TBS_LANG_CODE), $this->mainLink, $this->mainLink)?>
	</p>
</div>
