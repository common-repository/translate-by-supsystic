	...
	<div class="supsystic-item supsystic-panel">
		<div id="containerWrapper">
			<div class="supsistic-half-side-box supsystic-border-right">
				<?php if($this->faqList) {?>
					<h3><?php _e('FAQ and Documentation', TBS_LANG_CODE)?></h3>
					<div class="faq-list">
				...
				<div class="banner">
					<div class="text-block"><?php _e('If you want to host a business site or a blog, Kinsta managed WordPress hosting is the best place to stop on. Without any hesitation, we can say Kinsta is incredible when it comes to uptime and speed.', TBS_LANG_CODE)?></div>
					<a href="https://kinsta.com?kaid=MNRQQASUYJRT">
						<img src="<?php echo frameTbs::_()->getModule('supsystic_promo')->getModPath()?>img/kinsta_banner.png" style="width: 300px;height: 250px;" />
					</a>
				</div>
				<div class="server-settings">
					<h3><?php _e('Server Settings', TBS_LANG_CODE)?></h3>
			...
			<div class="supsistic-half-side-box" style="padding-left: 20px;">
				<?php if($this->news) {?>
					<div class="supsystic-overview-news">
						<h3><?php _e('News', TBS_LANG_CODE)?></h3>
						...
						<a href="<?php echo $this->mainLink?>" class="button button-primary button-hero" style="float: right; margin-top: 10px;">
							<i class="fa fa-info-circle"></i>
							<?php _e('All news and info', TBS_LANG_CODE)?>
						</a>
						<div style="clear: both;"></div>
					</div>
				<?php }?>
				<div class="overview-contact-form">
					<h3><?php _e('Contact form', TBS_LANG_CODE)?></h3>
					<form id="form-settings">
						<table class="contact-form-table">
							...
							<tr>
								...
								<td>
									<?php echo htmlTbs::$htmlType($fName, $htmlParams)?>
								</td>
							</tr>
							<?php }?>
							<tr>
								<th scope="row" colspan="2">
									<?php echo htmlTbs::hidden('mod', array('value' => 'supsystic_promo'))?>
									<?php echo htmlTbs::hidden('action', array('value' => 'sendContact'))?>
									<button class="button button-primary button-hero" style="float: right;">
										<i class="fa fa-upload"></i>
										<?php _e('Send email', TBS_LANG_CODE)?>
									</button>
									<div style="clear: both;"></div>
								</th>
							</tr>
					...
					<div id="form-settings-send-msg" style="display: none;">
						...
						<?php _e('Your email was sent, we will try to respond to your as soon as possible. Thank you for support!', TBS_LANG_CODE)?>
					</div>
				</div>
			</div>
			<div style="clear: both;"></div>
